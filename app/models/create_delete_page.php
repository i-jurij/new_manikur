...
class Create_delete_page extends Adm
{
    ...
    {
        $this->data['page_db_data'] = [['page_alias' => 'create_delete_page',
                                                'page_title' => 'Страницы',
                                    ...
                                    '} else {'.PHP_EOL,
                                        'echo \'<article class="main_section_article">'.PHP_EOL,
                                                ...
                                                '<div class="main_section_article_content"><br />'.PHP_EOL,
                                                    ...
                                                    '}'.PHP_EOL,
                                        'echo \'      <br />'.PHP_EOL,
                                                    '<a href="\'.URLROOT.\'/price#\'.$data[\'page_db_data\'][0][\'page_alias\'].\'" style="text-decoration: underline;">Прайс</a>'.PHP_EOL,
                                                '</div>'.PHP_EOL,
                                            '</article>\';'.PHP_EOL,
