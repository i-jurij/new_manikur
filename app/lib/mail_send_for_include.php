...
// Файлы phpmailer
require ROOT.DS.'phpmailer'.DS.'PHPMailer.php';
require ROOT.DS.'phpmailer'.DS.'SMTP.php';
require ROOT.DS.'phpmailer'.DS.'Exception.php';
...
$message .= '<ul>
            ...
            <hr>
            <p>
              <br><a href="'.URLROOT.'">new_manikur.ru</a>
            </p>';
